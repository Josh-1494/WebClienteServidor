...
<head>
    ...
    <script src="js/actualizaProductos.js"></script>
...
<body>
    ...
    <div id="formProductos" class="main">
            ...
            <input name="PRODUCTOID" type="text" id="PRODUCTOID" 
                value='<?php echo $PRODUCTOID ?>' hidden/>
                <br />
                ...
                PRECIO:<br />
                <input name="PRECIO" type="decimal" id="PRECIO" style="width:504px;" /><br />
                <br />
